...
# =============================================================================
# 03_index.sh — Build FAISS vector index from embeddings
# =============================================================================
# Usage:
#   bash 03_index.sh           # skip if index already exists
#   bash 03_index.sh --force   # force rebuild
# =============================================================================
...
echo "  Output: data/processed/faiss_index.idx"
echo "          data/processed/metadata.json"
echo "  Next:   bash 07_langchain_integration.sh"
echo "=============================================="
echo ""
